...
public class TrampSubsystemIO_HW implements TrampSubsystemIO {
  ...
  public TrampSubsystemIO_HW() {
    ...
    manipulator_motor_ =
        new CANSparkFlex(TrampConstants.Manipulator.kMotorCANID, MotorType.kBrushless);
    ...
    elevatorMotionMagicConfigs.MotionMagicCruiseVelocity =
        TrampConstants.Elevator.MotionMagic.kMaxVelocity;
    elevatorMotionMagicConfigs.MotionMagicAcceleration =
        TrampConstants.Elevator.MotionMagic.kMaxAcceleration;
  ...
  public void setArmPosition(double rps) {
    arm_motor_.setControl(
        new MotionMagicVoltage(rps / TrampConstants.Arm.kDegreesPerRev).withSlot(0));
  }
  ...
  public void setElevatorPosition(double pos) {
    elevator_motor_.setControl(
        new MotionMagicVoltage(pos / TrampConstants.Elevator.kMetersPerRev).withSlot(0));
  }

  public double getElevatorPosition() {
    return elevator_motor_.getPosition().getValueAsDouble()
        * 360
        / TrampConstants.Elevator.kMetersPerRev;
  }
